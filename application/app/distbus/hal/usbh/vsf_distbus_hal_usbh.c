...
static const vsf_distbus_service_info_t __vsf_distbus_hal_usbh_service_info = {
    .mtu                    = VSF_HAL_DISTBUS_CFG_MTU,
    .addr_range             = VSF_HAL_DISTBUS_USBH_CMD_ADDR_RANGE,
    .handler                = __vsf_distbus_hal_usbh_service_msghandler,
};
...
static bool __vsf_distbus_hal_usbh_service_msghandler(vsf_distbus_t *distbus,
                        vsf_distbus_service_t *service, vsf_distbus_msg_t *msg)
{
    vsf_distbus_hal_usbh_t *usbh = vsf_container_of(service, vsf_distbus_hal_usbh_t, service);
